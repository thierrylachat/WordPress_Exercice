...
function kale_customizer_fields( $fields ) {
    ...
    $fields[] = array(
        'type'        => 'text',
        'settings'    => 'kale_posts_excerpt_read_more_text',
        ...
        'section'     => 'kale_section_posts',
        'priority'    => 11,
        'default'     => $kale_defaults['kale_posts_excerpt_read_more_text']
    );
    $fields[] = array(
        'type'        => 'toggle',
        'settings'    => 'kale_posts_excerpt_read_more_link',
        ...
        'section'     => 'kale_section_posts',
        'priority'    => 12,
        'default'     => $kale_defaults['kale_posts_excerpt_read_more_link']
    );
